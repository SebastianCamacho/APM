...
using AppsielPrintManager.BlazorUI.Services;
...
namespace AppsielPrintManager.BlazorUI
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
...
#if ANDROID
            builder.Services.AddSingleton<IPlatformService, AppsielPrintManager.BlazorUI.Platforms.Android.Services.AndroidPlatformService>();
            ...
            builder.Services.AddSingleton<IPlatformService, AppsielPrintManager.BlazorUI.Platforms.Windows.Services.WindowsPlatformService>();
